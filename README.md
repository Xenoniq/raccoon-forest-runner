...
- Анимация енота через PNG-кадры: бег, прыжок, падение, смерть.
...
- Бесконечная генерация платформ, ям, пней, пчёл, яблок и фоновфх декораций.
...
- Система очков: дистанция + яблоки.
...
Так как выбран режим **auto-runner**, движение персонажа вперёд происходит автоматически. Игрок может слегка смещать енота по тропе влево/вправо, но основная задача — вовремя прыгать, собирать яблоки и сбивать пчёл камнями.
